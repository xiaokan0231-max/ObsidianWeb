...
// ra-batch は RA 広撒網応募（ra-batch-apply skill）が起票する案件。
// 「まとめて投げた中の1件」であることが後から効く——個別採点を経ていないので、
// 到達率を経路別に見るとき ai-reco と混ぜると母数の意味が変わる。
export const JOB_CASE_ORIGINS = ["ai-reco", "manual", "agent", "scout", "legacy", "ra-batch"];
