...
求人搜索、求人详情、站内消息和个人账号操作必须走本人已登录的浏览器会话
...
- 登录会话不可用时**停下来请本人接通**，不许退到无登录浏览器搜完就下结论，
  也不许代替本人执行登录操作。
- **公开资料例外（2026-09-14 本人指示）**：博客、员工访谈、公司／产品介绍等，
  未登录也能取得完整原文时，可直接用未登录浏览器或网页工具读取；即使托管在招聘站点也适用。
  只见摘要、节选或登录墙时须注明，不能当作已读全文。无需为公开全文另行要求登录。
